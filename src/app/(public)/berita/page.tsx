            ...
            >
              <div>
                <div className="relative h-60 w-full overflow-hidden">
                  ...
                  <span className="absolute top-4 left-4 bg-primary-10 text-amber-300 font-bold text-xs px-3 py-1 rounded-full border border-amber-400/30">
                    {item.category}
                  </span>
                </div>
                ...
                <div className="p-6 space-y-3">
                  <div className="flex items-center gap-4 text-xs text-slate-500">
                    ...
                    <span className="flex items-center gap-1">
                      <User className="w-3.5 h-3.5 text-primary-7" />
                      {item.author}
                    </span>
                  </div>

                  <h2 className="font-extrabold text-xl text-primary-10 group-hover:text-primary-7 transition-colors leading-snug">
                    {item.title}
                  </h2>
              ...
              <div className="p-6 pt-0">
                <Button 
                  asChild 
                  variant="outline" 
                  className="w-full justify-between border-slate-300 text-primary-9 font-bold hover:bg-primary-9 hover:text-white"
                >
